...
export default function Drawer() {
  ...
  return (
    <div className="drawer z-50 " style={{ zIndex: 999 }}>
      ...
      <div className="drawer-side b">
        <label
          htmlFor="my-drawer"
          aria-label="close sidebar"
          className="drawer-overlay"
        ></label>
        <ul className="menu p-4 w-60 min-h-full bg-slate-300 ">
          ...
          <motion.li
            ...
            animate={{ y: 0 }}
            onClick={scrollToTop}
            className="list-none font-bold text-5xl  cursor-pointer text-center py-8 text-nav-color"
          >
            C
          </motion.li>
          <motion.li
          ...
          >
            <Link
              ...
              className={`text-nav-color hover:border-b-4  border-b-slate-900  pb-2 ${
